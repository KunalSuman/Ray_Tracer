...
class camera
{
    ...
    public :
        ...
        camera(glm :: vec3 camera_pos , glm :: vec3 camera_target , glm :: vec3 camera_up) : view_matrix(1.0f) , camera_pos(camera_pos) , camera_target(camera_target) , camera_up(camera_up) {}        
        glm :: mat4 getView()
        {
            return view_matrix ;
        }
